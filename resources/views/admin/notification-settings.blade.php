...
var myChart = new Chart(ctx, {
    ...
    options: {
        ...
        setTimeout(function(){
            ...
            toastr.warning('<strong>Welcome to LUNA v.1.0</strong> <br/><small>Premium admin theme with Dark UI style. </small>');
        },1600)

        $('#totalusers').delay(800).animateNumber({ number: {{$totalUsers}} },900);
        $('#totalstudents').delay(800).animateNumber({ number: {{$totalStudents}} },900);
        $('#totalteachers').delay(800).animateNumber({ number: {{$totalTeachers}} },900);
        $('#totalparents').delay(800).animateNumber({ number: {{$totalParents}} },900);
        $('#analytics').delay(800).animateNumber({ number: 146000},900);
