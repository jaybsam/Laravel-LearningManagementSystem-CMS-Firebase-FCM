...
<div class="wrapper">
            ...
            <ul class="nav luna-nav">
                ...
                <li class="active">
                    ...
                    <ul id="users" class="nav nav-second collapse in">
                        ...
                        <li class="active"><a href="/admin/users/parents">Parent</a></li>
                    </ul>
                </li>
                <li>
    ...
    <section class="content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="view-header">
                            ...
                            <small>Academics<br>Users<br><span class="c-white">Parents</span></small>
                            </div>
                            <div class="header-icon">
                                <i class="pe page-header-icon pe-7s-user-female"></i>
                            </div>
                            <div class="header-title">
                                <h3 class="m-b-xs">Parents</h3>
                                <small>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-filled">
                            <div class="panel-body">
                                <div class="header-title">
                                <h3 class="m-b-xs">Create Parents</h3>
                                <small>
                                ...
                                <br/>
                                <a class="btn btn-default" href="/admin/users/parents/parentaccount">Create Parents</a>
                                </div><br/>
                            </div>
                        </div>
                        <hr>
                    ...
                    <div class="panel panel-filled">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <table id="parentslist" class="table table-hover table-bordered cell-border">
                                    <thead>
                                    <tr>
                                        <th id="rn"></th>
                                        <th id="rm">Profile</th>
                                ...
                                @if(!empty($parents))
                                    ...
                                    @if($guardian['disable'] == 0)
                                        <tr>
                                            <td>{{$guardian['id']}}</td>
                                            <td><img src="{{asset($guardian['profile'])}}" class="img-circle" width="35px"></td>
                                            <td>{{$guardian['parent_id']}}</td>
                                            ...
                                            <td>
                                                <form action="/admin/edit/parents/account/{{$guardian['id']}}" method="POST">
                                                @csrf
            ...
            <!-- disabled account parent -->
                 <div class="row">
                    <div class="col-md-12">
                    <div class="panel panel-filled">
                        <div class="panel-heading">
                            <p>Deactivated Parents</p>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">

                                <table id="parentlists1" class="table table-hover table-bordered cell-border">
                                    <thead>
                                    <tr>
                                        <th id="rn">#</th>
                                        <th id="rm">Profile</th>
