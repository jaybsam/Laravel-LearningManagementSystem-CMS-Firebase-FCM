            ...
            <ul class="nav luna-nav">
                ...
                <li class="active">
                    ...
                    <ul id="account" class="nav nav-second collapse in">
                        <li><a href="/admin/account/profile">Profile</a></li>
                        <li class="active"><a href="/admin/account/account-settings">Account Settings</a></li>
                    </ul>
                </li>
                <li>
            ...
            <div class="row">
                    <div class="col-lg-12">
                        <div class="view-header">
                            ...
                            <small>Academics<br><span class="c-white">Account Settings</span></small>
                            </div>
                            <div class="header-icon">
                                <i class="pe page-header-icon pe-7s-notebook"></i>
                            </div>
                            <div class="header-title">
                                <h3 class="m-b-xs">Account Settings</h3>
                                <small>
