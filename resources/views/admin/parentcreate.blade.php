    ...
    <section class="content">
            <div class="container-fluid">
                <div class="back-link mb-5">
                    <a href="/admin/users/parents" class="btn btn-accent">Back to Parents</a>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3 class="m-b-xs">Add Parents</h3>
                                <small>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <div class="form-group"><label for="inputEmail3" class="col-sm-2 control-label">Parent ID *</label>
                                    @if($id == null)
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <div class="form-group" style="width: 100%;">
                                    ...
                                    <div style="width: 50.8%; border-radius: 5px; margin: 0 auto; padding: 30px;">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-3 pull-right">
                                        <a class="btn btn-accent" data-toggle="modal" data-target="#createUser">Register Parent</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header text-center">
                                                ...
                                                <small>" We never know the love of a parent till we become parents ourselves."</small>
                                            </div>
                                            <div class="modal-body text-center">
                                                <h5 class="m-t-none">Are you sure you want to register this Parent?</h5>
...
<script>
    ...
    $uploadCrop = $('#profile-img-tag').croppie({
                enableExif: true,
                viewport: {
                    width: 200,
                    height: 200,
