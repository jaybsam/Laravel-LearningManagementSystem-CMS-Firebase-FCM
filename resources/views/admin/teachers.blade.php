            ...
            <ul class="nav luna-nav">
                ...
                <li class="active">
                    ...
                    <ul id="users" class="nav nav-second collapse in">
                        ...
                        <li class="active"><a href="/admin/users/teachers">Teacher</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="view-header">
                            ...
                            <small>Academics<br>Users<br><span class="c-white">Teacher</span></small>
                            </div>
                            <div class="header-icon">
                                <i class="pe page-header-icon pe-7s-users"></i>
                            </div>
                            <div class="header-title">
                                <h3 class="m-b-xs">Teacher</h3>
                                <small>
                                    “True teachers are those who use themselves as bridges over which they invite their students <br> to cross; then, having facilitated their crossing, joyfully collapse, encouraging them to create their own.”        
                                </small>
                            </div>
                        </div>
                        <hr>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-filled">
                            <div class="panel-body">
                                <div class="header-title">
                                <h3 class="m-b-xs">Create Teacher</h3>
                                <small>
                                ...
                                <br/>
                                <a class="btn btn-default" href="/admin/users/teachers/teacheraccount">Create Account</a>
                                </div><br/>
                            </div>
                        </div>
                        <hr>
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="teacherslist" class="table table-hover table-bordered cell-border">
                                 ...
                                 @if(!empty($teacher))
                                    ...
                                    <tr>
                                        <td>{{ $data['id'] }}</td>
                                        <td><img src="{{asset($data['profile'])}}" width="35" height="35" style="border-radius:200px;"></td>
                                        ...
                                        <td>
                                            <form action="/admin/edit/teachers/account/{{$data['id']}}" method="POST">
                                                @csrf
