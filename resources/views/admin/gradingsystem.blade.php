            ...
            <ul class="nav luna-nav">
                ...
                <li class="active">
                    ...
                    <ul id="grades" class="nav nav-second collapse in">
                        ...
                        <li class="active"><a href="/admin/grades/grading-system">Grading System</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <div class="col-lg-12">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3 class="m-b-xs">Grading System</h3>
                                <small>
                                       ...
                                       @if(!empty($subjects))
                                        @foreach($subjects as $subs)
                                            <tr>
                                                ...
                                                <td><a href="/admin/grades/grading-system/view/{{$subs['id']}}" class="text-primary">Grading System</a></td>
                                            </tr>
                                        @endforeach
                                       @endif
                                    </tbody>
    ...
    $(document).ready(function () {
        ...
        $('#addsection').click(function(e){
            ...
            $.ajax({
                ...
                data: {
                    '_token': $('input[name=_token]').val(), sectionname: $('input[name=name]').val(), description: $('textarea[name=description]').val(), level: $('select[name=level]').val(), room: $('input[name=room]').val(), status: $('select[name=status]').val()
                },
                dataType:'json',
                 success: function(data){
                    if(data.errors){
                        ...
                        toastr.success('Created a section' + data.sectionname, 'Success');
                        $('tbody').append('<tr class="sections' + data.id + '">'+
                                        '<td>'+ data.id +'</td>' +
                                     ...
                                     + '</td>' +
                                        '<td><button class="btn btn-primary" style="margin-right: 5px;"><span class="fa fa-edit" data-toggle="modal" data-target="#edit'+ data.id +'"></span></button><button class="btn btn-danger" data-toggle="modal" data-target="#delete'+ data.id +'"><span class="fa fa-trash"></span></button></td>' +
                                    '</tr>');
