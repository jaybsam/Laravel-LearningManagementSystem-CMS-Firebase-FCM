                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group"><label for="inputEmail3" class="col-sm-2 control-label">User ID *</label>
                                    ...
                                    @else
                                        @foreach($id as $primeID)
                                        <div class="col-xs-9"><input type="text" class="form-control" style="margin-bottom:10px;" name="idnumber" placeholder="ID number" autofocus required value="{{$primeID['id_number'] + 1}}" disabled></div>
                                        @endforeach
                                    @endif
                                </div>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <div class="form-group" style="width: 100%;">
                                    ...
                                    <img src="" id="profile-img-tag" width="200px" style="border-radius: 500px; border: 4px solid #fff;" />
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-3 pull-right">
                                        <a class="btn btn-accent btn-lg" data-toggle="modal" data-target="#createUser">Register User</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-center">
                                                <h5 class="m-t-none">Are you sure you want to register this user?</h5>
