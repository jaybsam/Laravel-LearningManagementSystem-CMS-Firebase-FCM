                    ...
                    <div class="col-lg-12">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3 class="m-b-xs">Add Teacher</h3>
                                <small>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <div class="form-group" style="width: 100%;">
                                    ...
                                    <img src="https://i.imgur.com/jNNT4LE.jpg" id="profile-img-tag" width="200px" height="200px" style="border-radius: 500px; border: 4px solid #fff;" />
                                    </div>
                                    ...
                                    <input type="file" name="file" id="profile-img" accept="image/x-png,image/gif,image/jpeg">
                                     </div>
                                 </div>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-3 pull-right">
                                        <a class="btn btn-accent" data-toggle="modal" data-target="#createUser">Register Teacher</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header text-center">
                                                ...
                                                <small>“I never teach my pupils. I only attempt to provide the einsteinconditions in which they can learn.” <br> —Albert Einstein</small>
                                            </div>
                                            <div class="modal-body text-center">
                                                <h5 class="m-t-none">Are you sure you want to register this Teacher?</h5>
