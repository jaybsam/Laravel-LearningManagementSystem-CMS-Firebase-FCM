      ...
      <div class="uk-offcanvas-content">
         ...
         <div class="uk-card uk-card-default uk-card-body uk-secondary dashboard-sidenav" style="position: fixed; z-index: 1000;" >
            <ul class="uk-nav-default uk-nav-parent-icon" uk-nav>
               ...
               <li class="uk-active"><a href="admin-dashboard-parents.html">Parents</a></li>
         ...
         <div class="uk-card uk-card-default uk-card-body uk-secondary dashboard-sidenav" style="opacity: 0;">
            ...
            <!-- Dashboard inner content -->
                ...
                <li><span>Teachers</span></li>
                      ...
                      <h3><span class="uk-icon uk-margin-small-right" uk-icon="icon: list;"></span>Parents List</h3>
                     </div>
                     <div class="dashboard-width-100">

              <div class="dashboard-float-right">
                        <button class="uk-button uk-button-primary uk-margin-small-right dashboard-icon-button" type="button" uk-toggle="target: #add-modal"><span class="uk-icon dashboard-custom-icon uk-margin-small-right" uk-icon="icon: plus;"></span> Create Parent</button>
                        <button class="uk-button dashboard-danger dashboard-light dashboard-icon-button"><span class="uk-icon dashboard-custom-icon uk-margin-small-right" uk-icon="icon: trash;"></span> Delete</button>
                        </div>
                      </div>
    ...
    <div class="uk-modal-dialog uk-modal-body dashboard-modal-dialog dashboard-radius-10">
      <div class="uk-modal-header">
        ...
        <div class="uk-modal-footer uk-text-right">
            ...
            <a href="#modal-group-1" class="uk-button uk-button-primary dashboard-radius-10" uk-toggle><span class="uk-icon uk-margin-small-right" uk-icon="icon: plus;"></span>Add Teacher</a>
        </div>
    </div>
</div>
   </body>
