            ...
            <nav class="uk-navbar">
                ...
                <div class="uk-navbar-flip">
                    <ul class="uk-navbar-nav user_actions">
                        ...
                        <li data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                            <p><span class="uk-margin-small-right" style="color:#fff;"></span> <a href="#" class="user_action_image uk-text-muted uk-text-uppercase">{{ $username }} <img class="uk-margin-small-left" src="../images/admin.png" width="30" style="border-radius: 500px;"><span style="content:'\e5c5';"></span></a></p>
...
<div id="top_bar">
 ...
 -->
			...
			@csrf
				...
				<div>
				<div class="uk-margin">
				<h4 class="uk-heading-line"><span>Student Account</span></h4>
				</div>
					<div class="uk-margin">
						<label>Username:</label>
	            		<input class="uk-input" type="text" name="username" placeholder="Username... (10000001)" required="">
	        		</div>
	        		<div class="uk-margin">
        		...
        		<div>
        		<div class="uk-margin">
        			<h4 class="uk-heading-line"><span>Personal Information</span></h4>
        		</div>
        			<div class="uk-margin">
	        		...
	        		<div class="uk-margin">
	            		...
	            		<input class="uk-input" type="text" name="middlename" placeholder="Middlename..." required="">
	        		</div>
	        		<div class="uk-margin">
	        		...
	        		<div class="uk-margin">
						<label>Address:</label>
	            		<textarea class="uk-textarea" name="address" rows="5" placeholder="Optional..."></textarea>
	            			        		</div>
	        		<div class="uk-margin-small-top uk-margin-medium-bottom">
						<label>Contact:</label>
	            		<input class="uk-input" type="number" name="contact" placeholder="Contact..." required="">
	        		</div>
	        	</div>
	        	</div>
        			    <div class="md-fab-wrapper">
        					<button type="submit" name="submit" value="Register" class="md-fab md-fab-primary" id="product_edit_submit">
