                            ...
                            '<td class="text-right"><div class="dropdown show d-inline-block widget-dropdown">' +
                                ...
                                '<ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-recent-order1">' + 
                                  '<li class="dropdown-item">' +
                                    '<a href="/mrhs/teacher/academics/schedule/view/{id}" class="text-primary font-weight-medium"><i class="mdi mdi-eye"></i> View</a>' +
                                  '</li>' +
                                  '<li class="dropdown-item">' +
            ...
            <!-- content -->
             ...
             <div class="row">
                <div class="col-lg-12 text-right">
                  <a href="/mrhs/teacher/academics/schedule" class="btn btn-outline-primary">Go to Schedule</a>
                </div>
             </div>

       <div class="row mt-3">
               <div class="col-lg-12">
                <div class="card card-default rounded bg-primary mb-4">
                    <div class="card-body">
                        <h1 class="text-white font-weight-medium">{{$mysched['section']}}</h1>
                         <p class="mt-3 text-white">Room : {{$mysched['room']}}</p>
                         <small class="text-white">{{$mysched['timestart']}} - {{$mysched['timeend']}} {{$mysched['day']}}</small>
               ...
               <div class="col-lg-12">
                 <div class="card card-default rounded bg-white mb-4">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-lg-10">
                          <button class="btn btn-outline-primary mb-3">Add Student</button><br>
                        </div>
                        <div class="col-lg-2 pull-right">
                          <small class="mt-5">Current Slot 0/{{$mysched['capacity']}}</small>
                        </div>
                      </div>
