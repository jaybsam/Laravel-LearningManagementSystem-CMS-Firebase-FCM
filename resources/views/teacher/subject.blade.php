    ...
    <div class="rect4"></div>
       ...
       <div class="content">
                <div class="bg-white border rounded">
                    ...
                    <div class="p-5">
                      <h3 class="text-primary">Lessons *</h3><br>
                        <div class="row">
                          @if(!empty($subjects))
                            @foreach($subjects as $subject)
                              @foreach($sched as $mysched)
                                @foreach($sectione as $section)
                                  @if($mysched['subject_id'] == $subject['subject_id'])
                                    @if($mysched['teacher_id'] == $profile['teacher_id'])
                                      @if($mysched['section_id'] == $section['section_id'])
                                          <div class="col-lg-3">
                                            <div class="card">
                                                <img class="card-img-top" src="{{asset($subject['image'])}}">
                                                @if($mysched['category'] == 'Primary')
                                                <span class="badge badge-primary">Teaching</span>
                                                @elseif($mysched['category'] == 'Secondary')
                                                <span class="badge badge-warning">Teaching</span>
                                                @endif
                                                <div class="card-body">
                                                  <h5 class="card-title text-primary">{{$subject['name']}} - <small>{{$section['sectionName']}}</small></h5>
                                                  <small class="text-primary">@if($mysched['start'] == 7.00)
                                                    07:00 AM
                                                @elseif($mysched['start'] == 7.50)
                                             07:30 AM
                                               @elseif($mysched['start'] == 8.00)
                                               08:00 AM
                                               @elseif($mysched['start'] == 8.50)
                                            08:30 AM
                                               @elseif($mysched['start'] == 9.00)
                                              09:00 AM
                                               @elseif($mysched['start'] == 9.50)
                                          09:30 AM
                                               @elseif($mysched['start'] == 10.00)
                                              10:00 AM
                                               @elseif($mysched['start'] == 10.50)
                                          10:30 AM
                                               @elseif($mysched['start'] == 11.00)
                                      11:00 AM
                                               @elseif($mysched['start'] == 11.50)
                                             >11:30 AM
                                               @elseif($mysched['start'] == 12.00)
                                               12:00 PM
                                               @elseif($mysched['start'] == 12.50)
                                               12:30 PM
                                               @elseif($mysched['start'] == 13.00)
                                             01:00 PM
                                               @elseif($mysched['start'] == 13.50)
                                        01:30 PM
                                               @elseif($mysched['start'] == 14.00)
                                       02:00 PM
                                               @elseif($mysched['start'] == 14.50)
                                          02:30 PM
                                               @elseif($mysched['start'] == 15.00)
                                           03:00 PM
                                               @elseif($mysched['start'] == 15.50)
                                          03:30 PM
                                               @elseif($mysched['start'] == 16.00)
                                              04:00 PM
                                               @elseif($mysched['start'] == 16.50)
                                             04:30 PM
                                               @elseif($mysched['start'] == 17.00)
                                              05:00 PM
                                               @elseif($mysched['start'] == 17.50)
                                             05:30 PM</option>
                                               @elseif($mysched['start'] == 18.00)
                                              06:00 PM
                                        @endif - @if($mysched['end'] == 7.00)
                                            07:00 AM
                                        @elseif($mysched['end'] == 7.50)
                                       07:30 AM
                                       @elseif($mysched['end'] == 8.00)
                                       08:00 AM
                                       @elseif($mysched['end'] == 8.50)
                                      08:30 AM
                                       @elseif($mysched['end'] == 9.00)
                                       09:00 AM
                                       @elseif($mysched['end'] == 9.50)
                                       09:30 AM
                                       @elseif($mysched['end'] == 10.00)
                                       10:00 AM
                                       @elseif($mysched['end'] == 10.50)
                                      10:30 AM
                                       @elseif($mysched['end'] == 11.00)
                                      11:00 AM
                                       @elseif($mysched['end'] == 11.50)
                                       11:30 AM
                                       @elseif($mysched['end'] == 12.00)
                                       12:00 PM
                                       @elseif($mysched['end'] == 12.50)
                                       12:30 PM
                                       @elseif($mysched['end'] == 13.00)
                                       01:00 PM
                                       @elseif($mysched['end'] == 13.50)
                                       01:30 PM
                                       @elseif($mysched['end'] == 14.00)
                                       02:00 PM
                                       @elseif($mysched['end'] == 14.50)
                                       02:30 PM
                                       @elseif($mysched['end'] == 15.00)
                                    03:00 PM
                                       @elseif($mysched['end'] == 15.50)
                                       03:30 PM
                                       @elseif($mysched['end'] == 16.00)
                                       04:00 PM
                                       @elseif($mysched['end'] == 16.50)
                                       ">04:30 PM
                                       @elseif($mysched['end'] == 17.00)
                                       05:00 PM
                                       @elseif($mysched['end'] == 17.50)
                                       >05:30 PM
                                       @elseif($mysched['end'] == 18.00)
                                       06:00 PM
                                        @endif</small><br>
                                                  <p class="card-text pb-3">{{$subject['description']}}</p>
                                                  <a href="/mrhs/teacher/academics/lessons/{{$subject['subject_id']}}" class="btn btn-outline-primary">Go somewhere</a>
                                                </div>
                                              </div>
                                          </div> 
                                         @endif
