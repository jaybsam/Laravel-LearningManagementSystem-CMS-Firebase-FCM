    ...
    <link href="{{asset('sleeze/assets/img/favicon.png')}}" rel="shortcut icon" />
      ...
      $(document).ready(function(){
        ...
        $('body').on('click', '.render', function(e){
          ...
          $.ajax({
            ...
            success:function(response){
              ...
              $('#studentlist').append('<tr id="r'+response.students.id+'"><td><img src="http://127.0.0.1:8000/'+response.students.profile+'" width="35" style="border-radius:100px;"></td><td>'+response.students.student_id+'</td><td>'+response.students.firstname+'</td><td>'+ response.students.lastname +'</td><td><span class="badge badge-warning">'+response.students.role+'</span></td><td><a class="btn btn-danger btn-sm btn-pill" href="#" id="remove" sid="'+response.students.student_id+'">Remove</a></td></tr>');
              $('#s'+response.students.id).replaceWith('<tr id="redo"></tr>');
            },
            complete:function(){
              $('#showhide').fadeOut();
        ...
        $('body').on('click', '#remove', function(e){
            ...
            $.ajax({
              type:'GET',
              url:'/mrhs/teacher/removestudent/'+ del,
              success:function(response){
                $('#r'+ response.id).remove();
                @if(!empty($mysect))
                  @if(!empty($profile))
                $('#redo').replaceWith('<tr id="s'+response.student.id+'"><td><img src="http://127.0.0.1:8000/'+response.student.profile+'" width="35" style="border-radius:100px;"></td><td>'+response.student.student_id+'</td><td>'+response.student.firstname+'</td><td>'+ response.student.lastname +'</td><td><span class="badge badge-warning">'+response.student.role+'</span></td><td><a class="mb-1 btn btn-sm btn-primary btn-pill render" href="#" id="gostudent" sid="'+response.student.student_id+'" tid="'+{{$profile['teacher_id']}}+'" sec="'+{{$mysect['section_id']}}+'">Add as student</a></td></tr>');
                  @endif
                @endif
              },
              complete:function(){
              ...
              <li
                ...
                <ul
                  ...
                  <div class="sub-menu">
                    ...
                    <li  
                      >
                      <a href="/mrhs/teacher/academics/schedule">My Schedule</a>
                    </li>
                  </div>
                </ul>
              </li>
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li class="dropdown-header">
                      ...
                      <div class="d-inline-block">
                        {{$profile['firstname']}} {{$profile['lastname']}} <small class="pt-1"><span class="mb-2 mr-2 badge badge-dark">USER ID {{$profile['teacher_id']}}</span></small> 
                      </div>
                    </li>
                    <li>
       ...
       <div class="content">              <div class="bg-white border rounded">
                <div class="row no-gutters">
                  <div class="col-lg-4 col-xl-3">
                    <div class="profile-content-left pt-5 pb-3 px-3 px-xl-5">
                      <div class="ribbon ribbon-top-left" style="z-index: 1000;"><span>Admin</span></div>
                      ...
                      <div class="card text-center widget-profile px-0 border-0">
                        ...
                        <div class="card-body">
                          <h4 class="py-2 text-dark">{{$profile['firstname']}} {{$profile['lastname']}}</h4>
                          <p>Albrecht.straub@gmail.com</p>

                          <a class="btn btn-primary btn-pill btn-lg my-4" href="#">Message</a>
                        </div>
                      </div>
                  ...
                  <div class="col-lg-8 col-xl-9">
                    <div class="profile-content-right py-5">
                      <ul class="nav nav-tabs px-3 px-xl-5 nav-style-border" id="myTab" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link" id="timeline-tab" data-toggle="tab" href="#timeline" role="tab" aria-controls="timeline" aria-selected="false">My Class</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true">Manage Class</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" id="settings-tab" data-toggle="tab" href="#settings" role="tab" aria-controls="settings" aria-selected="false">Class Statistics</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" id="settings-tab" data-toggle="tab" href="#rank" role="tab" aria-controls="rank" aria-selected="false">Class Rankings</a>
                        </li>
                      </ul>
                ...
                <div class="list-group mt-5">
                        <div class="list-group-item list-group-item-action flex-column align-items-start active">
                          ...
                          <small>
                            @if(!empty($mysect))
                          Capacity: {{$mysect['students']['studentsCount']}}/ {{$mysect['capacity']}}
                          @else
                          Not yet assigned
                        @endif</small>
                          </div>
                           ...
                           @if(!empty($mysect))
                          <p class="mb-1"> {{$mysect['description']}}</p>
                         @else
                        ...
                        <div class="list-group-item list-group-item-action flex-column align-items-start">
                          ...
                          <p class="mb-1">
                          @if(!empty($mysect))Grade {{$mysect['level']}}
                          @else
                          Not yet assigned
                        @endif</p>
                          <p class="mb-1">
                      ...
                      @if(!empty($mysect))
                      <button type="button" class="mb-1 mt-5 btn btn-primary" data-toggle="modal" data-target="#addstudent">Add Student</button>
                      <table class="table table-striped table-hover mt-2">

                        <thead>
                          <tr style="background: #4c84ff;">
                            <th style="color:#fff;" scope="col">Profile</th>
                            <th style="color:#fff;" scope="col">S.N</th>
                            <th style="color:#fff;" scope="col">Firstname</th>
                            <th style="color:#fff;" scope="col">Lastname</th>
                            <th style="color:#fff;" scope="col">Role</th>
                        ...
                        <tbody id="studentlist">
                          @if(!empty($mystudents))
                            ...
                            <tr id="r{{$cs['id']}}">
                              <td><img src="{{asset($cs['profile'])}}" width="35" style="border-radius: 100px;"></td>
                              <td>{{$cs['student_id']}}</td>
                              <td>{{$cs['firstname']}}</td>
                              <td>{{$cs['lastname']}}</td>
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalGridTitle">Sectionless List</h5>
                      ...
                      <div class="container-fluid">
                        ...
                        <tbody>
                          ...
                          <tr id="s{{$student['id']}}">
                            ...
                            <td><a class="mb-1 btn btn-sm btn-primary btn-pill render" href="#" id="gostudent" sid="{{$student['student_id']}}" tid="{{$profile['teacher_id']}}" sec="{{$mysect['section_id']}}">Add as student</a></td>
                          </tr>
                          @endif
                            @endforeach
                          @endif
