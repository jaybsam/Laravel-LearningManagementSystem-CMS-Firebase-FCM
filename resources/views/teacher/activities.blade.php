    ...
    <div class="wrapper">
            ...
            <ul class="nav sidebar-inner" id="sidebar-menu">
              ...
              <li
                ...
                <ul
                  ...
                  <div class="sub-menu">
                    <li
                      ...
                      <ul
                        ...
                        <div class="sub-menu">
                          <li  
                            >
                            <a href="../headers/header-fixed.html">Activities</a>
                          </li>
                          <li  
                            >
                            <a href="../headers/header-static.html">Assignments</a>
                          </li>
                          <li  
                            >
                            <a href="../headers/header-light.html">Manage Submission</a>
                          </li>
                        </div>
                      </ul>
                    </li>
                    <li
                      ...
                      <ul
                        ...
                        <div class="sub-menu">
                          <li  
                            >
                            <a href="sidebar-open.html">Subject</a>
                          </li>
                          <!--  -->
                        </div>
                      </ul>
                    ...
                    <li
                      ...
                      <ul
                        ...
                        <div class="sub-menu">
                          <li  
                            >
                            <a href="sidebar-open.html">Section</a>
                          </li>
                          <!--  -->
                        </div>
                      </ul>
                    ...
                    <li  
                      >
                      <a href="../../pages/user-profile.html">Schedule</a>
                    </li>
                  </div>
                </ul>
              </li>
              <li
                ...
                <ul
                  ...
                  <div class="sub-menu">
                    <li>
                      <a href="../../charts/chartjs.html">Student List</a>
                    </li>
                    <li
                      class="has-sub"
                      >
                      ...
                      <ul
                        ...
                        <div class="sub-menu">
                          <li  
                            >
                            <a href="../../ui-elements/icons/material-icon.html">Top 1 to 10</a>
                          </li>
                        </div>
                      </ul>
                    </li>
              ...
              <li class="has-sub">
                ...
                <ul
                  ...
                  <div class="sub-menu">
                    <li  
                      >
                      <a href="../../pages/user-profile.html">First</a>
                    </li>
                    <li  
                      >
                      <a href="../../pages/user-profile.html">Second</a>
                    </li>
                    <li  
                      >
                      <a href="../../pages/user-profile.html">Third</a>
                    </li>
                    <li  
                      >
                      <a href="../../pages/user-profile.html">Final Grading</a>
                    </li>
                  </div>
                </ul>
              </li>
              <li class="has-sub">
                ...
                <ul
                  ...
                  <div class="sub-menu">
                    ...
                    <li  
                      >
                      <a href="../../pages/user-profile.html">Account Settings</a>
                    </li>
                    <li
                      class="has-sub"
                      >
      ...
      <div class="row">
        <div class="col-12 col-lg-6">
                <div class="card card-default mb-4 mt-3 mt-md-0 bg-white pt-5">
                  <div class="card-header bg-white border-bottom-0">
                    <h2 class="text-center">Polar Chart</h2>
                  </div>
                  <div class="card-body pt-0" style="height: 400px;"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                    <canvas id="polar" width="350" height="370" class="chartjs-render-monitor" style="display: block; width: 350px; height: 370px;"></canvas>
                  </div>
                </div>
              </div>
              <div class="col-12 col-lg-6">
                <div class="card card-default mb-4 mt-3 mt-md-0 bg-white pt-5">
                  ...
                  <div class="card-body pt-0" style="height: 400px;"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                    <canvas id="deviceChart" width="350" height="370" class="chartjs-render-monitor" style="display: block; width: 350px; height: 370px;"></canvas>
                  </div>
                </div>
              </div>
      </div>
        ...
        <div class=" col-xl-4 ">
                          ...
                          <!-- Page Views  -->
                          <div class="card card-default table-borderless mb-4 bg-white pt-5" id="page-views" data-scroll-height="580">
        ...
        <div class=" col-xl-4 ">
          <!-- Notification Table -->
          <div class="card card-default mb-4 bg-white pt-5" data-scroll-height="580">
            <div class="card-header d-flex flex-wrap justify-content-between bg-white border-bottom-0 mb-4">
              <h2>Latest Notifications</h2>
              <div>
                <button class="text-black-50 mr-2 font-size-20"><i class="mdi mdi-cached"></i></button>
                <div class="dropdown show d-inline-block widget-dropdown">
                  <a class="dropdown-toggle icon-burger-mini" href="#" role="button" id="dropdown-notification" data-toggle="dropdown"
