      ...
      $(document).ready(function(){
        ...
        $('#addschedule').click(function(e){
          ...
          $.ajax({
            ...
            data: {'_token': $('input[name=_token]').val(), class: '123456', section: 'Section Name', room: 'Room #', subject: 'Subject Name', timestart: '7:00 AM', timeend: '7:00 AM', day: 'Monday to Friday'},
            dataType: 'json',
            success: function(data){
              console.log(data);
                $('#hash').append('<div class="col-md-6"><div class="card mb-4"><div class="card-body"><h5 class="card-title text-primary">'+ data.section +'</h5><p class="card-text pb-3">'+ data.subject +'</p><small >' + data.timestart + ' To ' + data.timeend + ' </small><a href="#" class="btn btn-outline-primary" data-toggle="modal" data-target="#sched">Setup</a></div></div></div>');
            },
            complete: function(){
              $('#showhide').fadeOut();
            }
    ...
    <div class="rect4"></div>
        ...
        <div class="content-wrapper">
          <div class="content">
            ...
            <div class="row mb-5">
              <div class="col-lg-12">
                <a class="mb-1 btn btn-rounded btn-md btn-primary" id="addschedule">Add Schedule</a>
              </div>
              <hr/>
            </div>
                     <!-- Grid Modal -->
            <div class="modal fade" id="sched" tabindex="-1" role="dialog" aria-labelledby="exampleModalGrid" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalGridTitle">New Schedule</h5>
                      ...
                      <div class="container-fluid">
                        <div class="row">
                          ...
                          <div class="col-md-6">
                              ...
                              <select id="sectionName" class="form-control" name="sectionName" required>
                        ...
                        <div class="row mt-3">
                          <div class="col-md-4">
                              ...
                              <input type="time" id="start" class="form-control" name="start">
                          </div>
                          <div class="col-md-4">
                            <label for="#end"></label>
                            <input type="time" id="end" class="form-control" name="end">
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="row" id="hash">
              ...
              <div class="col-md-6">
                      <div class="card mb-4">
                        <div class="card-body">
                          <h5 class="card-title text-primary">{{$sched['section']}}</h5>
                          <p class="card-text pb-3">{{$sched['subject']}}</p>
                          <small >{{$sched['timestart']}} To {{$sched['timeend']}}</small>
                          <a href="#" class="btn btn-outline-primary" data-toggle="modal" data-target="#sched">Setup</a>
                        </div>
                      </div>
                    </div>
                    @endforeach
