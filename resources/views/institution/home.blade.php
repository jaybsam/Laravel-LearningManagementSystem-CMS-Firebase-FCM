...
<html style="background: none;">
   ...
   <body style="background: rgb(241, 234, 234);">
...
<!--             <nav class="uk-navbar-container uk-background-primary uk-light uk-position-fixed-top uk-secondary" uk-navbar>
         ...
         <!-- Dashboard-content -->
         <div class="uk-container uk-margin-medium-top dashboard-content">
         <!-- Sidebar -->
         <!-- Sidenav -->
         <div class="uk-card uk-card-default uk-card-body uk-secondary dashboard-sidenav" style="position: relative; z-index: 1000;">
